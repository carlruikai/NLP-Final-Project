...
from read_data import load_file_science
...
if __name__ == '__main__':
    ...
    # For CoNLL-2000
    X_train_1 = [sent2features(s) for s in sentence_sci_tr]
    y_train_1 = [sent2labels(s) for s in sentence_sci_tr]

    X_test_1 = [sent2features(s) for s in sentence_sci_test]
    y_test_1 = [sent2labels(s) for s in sentence_sci_test]
    ...
    print("start training with searchCV")
    # search
